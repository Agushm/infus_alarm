...
class _NotificationPageState extends State<NotificationPage> {
  ...
  void _configureDidReceiveLocalNotificationSubject() {
    LocalNotification.didReceiveLocalNotificationSubject.stream
  ...
  void _configureSelectNotificationSubject() {
    LocalNotification.selectNotificationSubject.stream
  ...
  Future<void> _cancelNotification() async {
    await LocalNotification.flutterLocalNotificationsPlugin.cancel(0);
  }
  ...
  Future<void> _showNotificationCustomSound() async {
    ...
    final LinuxNotificationDetails linuxPlatformChannelSpecifics =
      ...
      sound: AssetsLinuxSound('sound/ringtone.mp3'),
    );
  ...
  Future<void> _showNotificationWithNoSound() async {
    ...
    const NotificationDetails platformChannelSpecifics = NotificationDetails(
        ...
        iOS: iOSPlatformChannelSpecifics,
        macOS: macOSPlatformChannelSpecifics);
    await LocalNotification.flutterLocalNotificationsPlugin.show(0,
  ...
  Future<void> _showSoundUriNotification() async {
    ...
    final String? alarmUri =
        await LocalNotification.platform.invokeMethod<String>('getAlarmUri');
  ...
  Future<void> _showMessagingNotification() async {
    ...
    final String? imageUri =
        await LocalNotification.platform.invokeMethod('drawableToUri', 'food');
  ...
  Future<void> _repeatNotification() async {
    ...
    const NotificationDetails platformChannelSpecifics =
        NotificationDetails(android: androidPlatformChannelSpecifics);
    await LocalNotification.flutterLocalNotificationsPlugin.periodicallyShow(
        0,
        'repeating title',
        'repeating body',
  ...
  Future<void> _areNotifcationsEnabledOnAndroid() async {
    final bool? areEnabled = await LocalNotification
  ...
  Future<Widget> _getNotificationChannelsDialogContent() async {
    try {
      final List<AndroidNotificationChannel>? channels = await LocalNotification
          .flutterLocalNotificationsPlugin
          .resolvePlatformSpecificImplementation<
              AndroidFlutterLocalNotificationsPlugin>()!
